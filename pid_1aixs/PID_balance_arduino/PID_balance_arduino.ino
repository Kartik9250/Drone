...
double throttle=1125; //initial value of throttle to the motors
...
void setup() {
  ...
  Serial.begin(9600);
  right_prop.attach(12); //attatch the right motor to pin 3
...
Finally we multiply the result by the derivate constant*/
...
//Serial.println(String(pwmLeft)+" , "+String(pwmRight));
